...
@section('contenido')
    <div class="fixed-image-container">       
        ...
        <div class="centered-content">
            <h2>LIBROS</h2>
            <h1>Asociación Pukllasunchis</h1>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 text-center">
                        <button class="btn btn-outline-primary btn-sm me-2 mb-2" onclick="ordenarPor('nombre')">Ordenar por
                            <strong>nombre de libro</strong> A-Z <i class="fa fa-sort"></i></button>
                        <button class="btn btn-outline-secondary btn-sm mb-2" onclick="ordenarPor('autor')">Ordenar por
                            <strong>autor</strong>
                            A-Z <i class="fa fa-sort"></i></button>
                    ...
                    <div id="contenedorLibros" class="row">
                        @foreach ($libros as $libro)
                            <div class="col-lg-4 mb-4 cardLibros" data-nombre="{{ $libro->nombre }}"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class='text-center' style="font-size: 15px">{{ $libro->nombre }}</h5>
                                        <p class="text-center" style="font-size: 13px"><i style="font-size: 12px"
                                                class="fa fa-user"></i> {{ $libro->autor }}</p>
                                        @php
